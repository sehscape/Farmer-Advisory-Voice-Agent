...
|---|---|---|---|---|
| **A. Google Colab** | Free | ❌ Only while the tab is open | **Everything** — mic, real LLM, semantic search, voice | Live demo / viva |
| **B. Render (Lite)** | Free | ✅ Yes (sleeps when idle, wakes on visit) | Typed input, weather, crop advice, keyword scheme search, English voice | A permanent portfolio link |
...
- The answer plays as English voice and the tool badges light up.

### Notes

- The free instance **sleeps after ~15 min** with no visitors; the next visit
  wakes it in ~30–60 s. That's normal for the free tier.
